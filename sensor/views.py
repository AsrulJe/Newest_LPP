...
def sampling(request):
    ...
    # api_url = 'http://192.168.87.158:8080/api/item/' +str(dryer_id) + '/batch'
    # api_url = 'http://192.168.87.158:8080/api/item/1/batch'
    # app_requests = requests.get(api_url)
    # data_json = app_requests.json()
    # i = data_json[0]['batch_id']
    ...
    # batch_collection = 'batch_dryer_' + str(1)
    # new_batch_collection = func.checkDatabase(batch_collection)

    # i = new_batch_collection.find()
...
#     dryerid = range(28)
#     for n in dryerid:
#         response = requests.get('https://aie.loranet.my/api/item/n+1/batch')
#         jsondata = response.json()
#         for < loop based on json data
#             if batch id yang paling Besar
        
#         append data
#     return render(request, 'sensor/track.html'), {
#         'batch': jsondata['batch'],
#         'time': jsondata['total_finished_time']
#     }
